...
--
-- 補足（アプリ機能と DB）:
--   - 一覧の URL 自動リンク化（content / next_action）は表示処理のみ。
--     本 SQL の再実行やスキーマ変更は不要（docs/02_DB仕様書.md 1.4 参照）。
-- ============================================================
...
-- ============================================================
-- （参考）一覧 URL 自動リンク化について
-- ------------------------------------------------------------
-- 2026-05 以降、index.html の一覧表示で content / next_action 内の
-- http:// および https:// をリンク表示する機能を追加した。
-- データは従来どおり text 列にプレーン文字列で保存するため、
-- 上記セクション 1〜4 の DDL / DML を変更する必要はない。
-- ============================================================
